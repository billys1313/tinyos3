...
typedef struct thread_control_block {
  ...
  /*EDITS.........*/
  int priority;           // priority for multilevel feedback queue
  int previous_priority;   //to restore priority after curr_cause=SCHED_MUTEX && last_cause=SCHED_MUTEX && next_cause!=SCHED_CAUSE
  PTCB* ptcb_tcb;         //tcb ptcb connection
...
/*EDITS.........*/
/*This function changes the priority based on :
      SCHED_CAUSE
*/
